...
function Install() {
    ...
    # update php.ini line 1868: 1800->1
    sed -i "1868s/1800/1/g" /opt/bksite/php/etc/php.ini

    # change config to open debug mode
    sed -i '/$CFG->debug/s#\/\/##g' /opt/bookoo/htdocs/config.php
}
